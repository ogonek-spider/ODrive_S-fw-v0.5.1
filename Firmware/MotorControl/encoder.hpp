...
public:
    ...
    struct Config_t {
        ...
        // spider-motor-tools/harmonic_calibration.py) and saved to NVM. Kept
        // OFF by default; the firmware clamps the applied correction so a bad
        // fit can never corrupt commutation (see encoder.cpp).
